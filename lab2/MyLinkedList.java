...
public class MyLinkedList <E> implements ListInterface<E> {
    private Node <E> head; 
    private int numNode; public MyLinkedList(){
    head = null;
    numNode = 0; 
}
...
public void addFirst(E item){
    head = new Node<E>(item, head); numNode++;
}

@Override
public void addAfter(Node<E> curr, E item){
    if(curr == null){ addFirst(item);
    }
    else{
...
public void addLast(E item){
    ...
    { 
        ...
        Node<E> tmp = head; while(tmp.getNext() != null){
        tmp = tmp.getNext(); }
        Node<E> newNode = new Node<>(item, null); tmp.setNext(newNode);
        numNode++; 
    }
}
...
public E removeLast() throws NoSuchElementException {
    if(head == null){
        ...
        Node<E> preNode = null;
        Node<E> delNode = head; while(delNode.getNext() != null){
        preNode = delNode;
        delNode = delNode.getNext(); }
        preNode.setNext(delNode.getNext());
        delNode.setNext(null); numNode--;
        return delNode.getData();
    } 
}
...
public void print1(){ 
    if(head != null){
        ...
        System.out.print("List: " + (Fraction)tmp.getData().numer()); tmp = tmp.getNext();
        while(tmp != null)
        {
            System.out.print(" -> " + (Fraction) tmp.getData().numer()); 
            tmp = tmp.getNext();
        }
        System.out.println();
    }
